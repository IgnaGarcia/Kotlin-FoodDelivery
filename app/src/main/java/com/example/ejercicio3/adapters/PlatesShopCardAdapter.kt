...
import com.example.ejercicio3.ui.MainActivity
...
class PlatesShopCardAdapter(var plates : List<Plate>, var onClickPlate : OnClickPlate, var type : Int)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int)
            : PlatesShopCardAdapter.BaseViewHolder {
        var view = LayoutInflater.from(parent.context)
                .inflate(R.layout.item_plates_shop_card, parent, false)
        return BaseViewHolder(view)
    }

    override fun onBindViewHolder(holder: PlatesShopCardAdapter.BaseViewHolder, position: Int) {
